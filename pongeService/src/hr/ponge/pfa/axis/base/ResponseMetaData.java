...
/** 
 *  ResponseMetaData bean class
 */
@java.lang.SuppressWarnings(value = {"unchecked" ,"unused"})
public class ResponseMetaData implements hr.ponge.pfa.service.base.ResponseMetaData , org.apache.axis2.databinding.ADBBean {
    /** 
     * field for RequestId
     */
     ...
     * field for Error
     */
    protected hr.ponge.pfa.axis.base.ErrorType localError;
     ...
     */
    public hr.ponge.pfa.axis.base.ErrorType getError() {
        return localError;
    }
     ...
     * @param param Error
     */
    public void setError(hr.ponge.pfa.axis.base.ErrorType param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType) throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && ((namespacePrefix.trim().length()) > 0)) {
                writeAttribute("xsi" ,"http://www.w3.org/2001/XMLSchema-instance" ,"type" ,(namespacePrefix + ":ResponseMetaData") ,xmlWriter);
            } else {
                writeAttribute("xsi" ,"http://www.w3.org/2001/XMLSchema-instance" ,"type" ,"ResponseMetaData" ,xmlWriter);
            }
        } 
        ...
        if (localErrorTracker) {
            ...
            localError.serialize(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/base" , "error") ,xmlWriter);
        } 
        xmlWriter.writeEndElement();
    }
    ...
    private void writeStartElement(java.lang.String prefix, java.lang.String namespace, java.lang.String localPart, javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
        ...
        if (writerPrefix != null) {
            ...
            if ((namespace.length()) == 0) {
                ...
                prefix = hr.ponge.pfa.axis.base.ResponseMetaData.generatePrefix(namespace);
            } 
    ...
    private void writeQName(javax.xml.namespace.QName qname, javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
        ...
        if (namespaceURI != null) {
            ...
            if (prefix == null) {
                prefix = hr.ponge.pfa.axis.base.ResponseMetaData.generatePrefix(namespaceURI);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
        ...
        if (localErrorTracker) {
            elementList.add(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/base" , "error"));
            if ((localError) == null) {
                throw new org.apache.axis2.databinding.ADBException("error cannot be null!!");
            } 
    ...
    public static class Factory {
         ...
         */
        public static hr.ponge.pfa.axis.base.ResponseMetaData parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            hr.ponge.pfa.axis.base.ResponseMetaData object = new hr.ponge.pfa.axis.base.ResponseMetaData();
            int event;
            ...
            try {
                ...
                if ((reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance" ,"type")) != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!("ResponseMetaData".equals(type))) {
                            ...
                            return ((hr.ponge.pfa.axis.base.ResponseMetaData)(hr.ponge.pfa.axis.ExtensionMapper.getTypeObject(nsUri ,type ,reader)));
                        } 
                    } 
                } 
                ...
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
                if ((reader.isStartElement()) && (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/base" , "error").equals(reader.getName()))) {
                    object.setError(hr.ponge.pfa.axis.base.ErrorType.Factory.parse(reader));
                    reader.next();
                } else {
                }
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
