...
public class ReadDocumentResp implements hr.ponge.pfa.service.core.document.ReadDocumentRespDTO , org.apache.axis2.databinding.ADBBean {
     ...
     * This was an Array!
     */
    protected hr.ponge.pfa.axis.core.Document[] localDocuments;
     ...
     */
    public hr.ponge.pfa.axis.core.Document[] getDocuments() {
     ...
     */
    protected void validateDocuments(hr.ponge.pfa.axis.core.Document[] param) {
    }
     ...
     */
    public void setDocuments(hr.ponge.pfa.axis.core.Document[] param) {
     ...
     * @param param hr.ponge.pfa.axis.core.Document
     */
    public void addDocuments(hr.ponge.pfa.axis.core.Document param) {
        if ((localDocuments) == null) {
            localDocuments = new hr.ponge.pfa.axis.core.Document[]{  };
        } 
        localDocumentsTracker = true;
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localDocuments);
        list.add(param);
        this.localDocuments = ((hr.ponge.pfa.axis.core.Document[])(list.toArray(new hr.ponge.pfa.axis.core.Document[list.size()])));
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType) throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && ((namespacePrefix.trim().length()) > 0)) {
                writeAttribute("xsi" ,"http://www.w3.org/2001/XMLSchema-instance" ,"type" ,(namespacePrefix + ":ReadDocumentResp") ,xmlWriter);
            } else {
                writeAttribute("xsi" ,"http://www.w3.org/2001/XMLSchema-instance" ,"type" ,"ReadDocumentResp" ,xmlWriter);
            }
        } 
            ...
            if ((localDocuments) != null) {
                for (int i = 0 ; i < (localDocuments.length) ; i++) {
                    if ((localDocuments[i]) != null) {
                        localDocuments[i].serialize(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/core/operations" , "documents") ,xmlWriter);
                    } else {
                    }
                }
            } else {
    ...
    private void writeStartElement(java.lang.String prefix, java.lang.String namespace, java.lang.String localPart, javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
        ...
        if (writerPrefix != null) {
            ...
            if ((namespace.length()) == 0) {
                ...
                prefix = hr.ponge.pfa.axis.core.operations.ReadDocumentResp.generatePrefix(namespace);
            } 
    ...
    private void writeQName(javax.xml.namespace.QName qname, javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
        ...
        if (namespaceURI != null) {
            ...
            if (prefix == null) {
                prefix = hr.ponge.pfa.axis.core.operations.ReadDocumentResp.generatePrefix(namespaceURI);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
        ...
        if (localDocumentsTracker) {
            if ((localDocuments) != null) {
                for (int i = 0 ; i < (localDocuments.length) ; i++) {
                    if ((localDocuments[i]) != null) {
                        elementList.add(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/core/operations" , "documents"));
    ...
    public static class Factory {
         ...
         */
        public static hr.ponge.pfa.axis.core.operations.ReadDocumentResp parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            hr.ponge.pfa.axis.core.operations.ReadDocumentResp object = new hr.ponge.pfa.axis.core.operations.ReadDocumentResp();
            int event;
            ...
            try {
                ...
                if ((reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance" ,"type")) != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!("ReadDocumentResp".equals(type))) {
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return ((hr.ponge.pfa.axis.core.operations.ReadDocumentResp)(hr.ponge.pfa.axis.ExtensionMapper.getTypeObject(nsUri ,type ,reader)));
                        } 
                    } 
                } 
                ...
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
                if ((reader.isStartElement()) && (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/core/operations" , "documents").equals(reader.getName()))) {
                    list1.add(hr.ponge.pfa.axis.core.Document.Factory.parse(reader));
                    ...
                    while (!loopDone1) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/core/operations" , "documents").equals(reader.getName())) {
                                list1.add(hr.ponge.pfa.axis.core.Document.Factory.parse(reader));
                            } else {
                                loopDone1 = true;
                            }
                    ...
                    object.setDocuments(((hr.ponge.pfa.axis.core.Document[])(org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(hr.ponge.pfa.axis.core.Document.class ,list1))));
                } else {
                }
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
