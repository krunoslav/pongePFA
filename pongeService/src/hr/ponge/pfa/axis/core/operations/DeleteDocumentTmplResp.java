...
/** 
 *  DeleteDocumentTmplResp bean class
 */
@java.lang.SuppressWarnings(value = {"unchecked" ,"unused"})
public class DeleteDocumentTmplResp implements org.apache.axis2.databinding.ADBBean {
    /** 
     * field for DocumentTmpl
     */
    protected hr.ponge.pfa.axis.core.DocumentTemplate localDocumentTmpl;
    
    protected boolean localDocumentTmplTracker = false;
    
    public boolean isDocumentTmplSpecified() {
        return localDocumentTmplTracker;
    }
     ...
     */
    public hr.ponge.pfa.axis.core.DocumentTemplate getDocumentTmpl() {
        return localDocumentTmpl;
    }
    
    /** 
     * Auto generated setter method
     * @param param DocumentTmpl
     */
    public void setDocumentTmpl(hr.ponge.pfa.axis.core.DocumentTemplate param) {
        localDocumentTmplTracker = param != null;
        this.localDocumentTmpl = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType) throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && ((namespacePrefix.trim().length()) > 0)) {
                writeAttribute("xsi" ,"http://www.w3.org/2001/XMLSchema-instance" ,"type" ,(namespacePrefix + ":DeleteDocumentTmplResp") ,xmlWriter);
            } else {
                writeAttribute("xsi" ,"http://www.w3.org/2001/XMLSchema-instance" ,"type" ,"DeleteDocumentTmplResp" ,xmlWriter);
            }
        } 
        if (localDocumentTmplTracker) {
            if ((localDocumentTmpl) == null) {
                throw new org.apache.axis2.databinding.ADBException("documentTmpl cannot be null!!");
            } 
            localDocumentTmpl.serialize(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/core/operations" , "documentTmpl") ,xmlWriter);
        } 
    ...
    private void writeStartElement(java.lang.String prefix, java.lang.String namespace, java.lang.String localPart, javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
        ...
        if (writerPrefix != null) {
            ...
            if ((namespace.length()) == 0) {
                ...
                prefix = hr.ponge.pfa.axis.core.operations.DeleteDocumentTmplResp.generatePrefix(namespace);
            } 
    ...
    private void writeQName(javax.xml.namespace.QName qname, javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
        ...
        if (namespaceURI != null) {
            ...
            if (prefix == null) {
                prefix = hr.ponge.pfa.axis.core.operations.DeleteDocumentTmplResp.generatePrefix(namespaceURI);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
        ...
        if (localDocumentTmplTracker) {
            elementList.add(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/core/operations" , "documentTmpl"));
            if ((localDocumentTmpl) == null) {
                throw new org.apache.axis2.databinding.ADBException("documentTmpl cannot be null!!");
            } 
            elementList.add(localDocumentTmpl);
        } 
        if (localErrorsTracker) {
            if ((localErrors) != null) {
                for (int i = 0 ; i < (localErrors.length) ; i++) {
    ...
    public static class Factory {
         ...
         */
        public static hr.ponge.pfa.axis.core.operations.DeleteDocumentTmplResp parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            hr.ponge.pfa.axis.core.operations.DeleteDocumentTmplResp object = new hr.ponge.pfa.axis.core.operations.DeleteDocumentTmplResp();
            int event;
            ...
            try {
                ...
                if ((reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance" ,"type")) != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!("DeleteDocumentTmplResp".equals(type))) {
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return ((hr.ponge.pfa.axis.core.operations.DeleteDocumentTmplResp)(hr.ponge.pfa.axis.ExtensionMapper.getTypeObject(nsUri ,type ,reader)));
                        } 
                    } 
                } 
                ...
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
                if ((reader.isStartElement()) && (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/core/operations" , "documentTmpl").equals(reader.getName()))) {
                    object.setDocumentTmpl(hr.ponge.pfa.axis.core.DocumentTemplate.Factory.parse(reader));
                    reader.next();
                } else {
                }
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
