...
/** 
 *  DeletePictureTmplResp bean class
 */
@java.lang.SuppressWarnings(value = {"unchecked" ,"unused"})
public class DeletePictureTmplResp implements hr.ponge.pfa.service.core.pictureTmpl.DeletePictureTmplRespDTO , org.apache.axis2.databinding.ADBBean {
    /** 
     * field for PictureTmpl
     */
    protected hr.ponge.pfa.axis.core.PictureTemplate localPictureTmpl;
    
    protected boolean localPictureTmplTracker = false;
    
    public boolean isPictureTmplSpecified() {
        return localPictureTmplTracker;
    }
     ...
     */
    public hr.ponge.pfa.axis.core.PictureTemplate getPictureTmpl() {
        return localPictureTmpl;
    }
    
    /** 
     * Auto generated setter method
     * @param param PictureTmpl
     */
    public void setPictureTmpl(hr.ponge.pfa.axis.core.PictureTemplate param) {
        localPictureTmplTracker = param != null;
        this.localPictureTmpl = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType) throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && ((namespacePrefix.trim().length()) > 0)) {
                writeAttribute("xsi" ,"http://www.w3.org/2001/XMLSchema-instance" ,"type" ,(namespacePrefix + ":DeletePictureTmplResp") ,xmlWriter);
            } else {
                writeAttribute("xsi" ,"http://www.w3.org/2001/XMLSchema-instance" ,"type" ,"DeletePictureTmplResp" ,xmlWriter);
            }
        } 
        if (localPictureTmplTracker) {
            if ((localPictureTmpl) == null) {
                throw new org.apache.axis2.databinding.ADBException("pictureTmpl cannot be null!!");
            } 
            localPictureTmpl.serialize(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/core/operations" , "pictureTmpl") ,xmlWriter);
        } 
    ...
    private void writeStartElement(java.lang.String prefix, java.lang.String namespace, java.lang.String localPart, javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
        ...
        if (writerPrefix != null) {
            ...
            if ((namespace.length()) == 0) {
                ...
                prefix = hr.ponge.pfa.axis.core.operations.DeletePictureTmplResp.generatePrefix(namespace);
            } 
    ...
    private void writeQName(javax.xml.namespace.QName qname, javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
        ...
        if (namespaceURI != null) {
            ...
            if (prefix == null) {
                prefix = hr.ponge.pfa.axis.core.operations.DeletePictureTmplResp.generatePrefix(namespaceURI);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
        ...
        if (localPictureTmplTracker) {
            elementList.add(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/core/operations" , "pictureTmpl"));
            if ((localPictureTmpl) == null) {
                throw new org.apache.axis2.databinding.ADBException("pictureTmpl cannot be null!!");
            } 
            elementList.add(localPictureTmpl);
        } 
        if (localErrorsTracker) {
            if ((localErrors) != null) {
                for (int i = 0 ; i < (localErrors.length) ; i++) {
    ...
    public static class Factory {
         ...
         */
        public static hr.ponge.pfa.axis.core.operations.DeletePictureTmplResp parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            hr.ponge.pfa.axis.core.operations.DeletePictureTmplResp object = new hr.ponge.pfa.axis.core.operations.DeletePictureTmplResp();
            int event;
            ...
            try {
                ...
                if ((reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance" ,"type")) != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!("DeletePictureTmplResp".equals(type))) {
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return ((hr.ponge.pfa.axis.core.operations.DeletePictureTmplResp)(hr.ponge.pfa.axis.ExtensionMapper.getTypeObject(nsUri ,type ,reader)));
                        } 
                    } 
                } 
                ...
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
                if ((reader.isStartElement()) && (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/core/operations" , "pictureTmpl").equals(reader.getName()))) {
                    object.setPictureTmpl(hr.ponge.pfa.axis.core.PictureTemplate.Factory.parse(reader));
                    reader.next();
                } else {
                }
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
    ...
    public hr.ponge.pfa.service.core.pictureTmpl.PictureTmplDTO getPictureTmpl_() {
        return getPictureTmpl();
    }
