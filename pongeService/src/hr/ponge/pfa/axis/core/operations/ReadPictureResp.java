...
/** 
 *  ReadPictureResp bean class
 */
@java.lang.SuppressWarnings(value = {"unchecked" ,"unused"})
public class ReadPictureResp implements hr.ponge.pfa.service.core.picture.ReadPictureRespDTO , org.apache.axis2.databinding.ADBBean {
    /** 
     * field for Pictures
     * This was an Array!
     */
    protected hr.ponge.pfa.axis.core.Picture[] localPictures;
     ...
     */
    public hr.ponge.pfa.axis.core.Picture[] getPictures() {
        return localPictures;
    }
    
    /** 
     * validate the array for Pictures
     */
    protected void validatePictures(hr.ponge.pfa.axis.core.Picture[] param) {
    }
     ...
     */
    public void setPictures(hr.ponge.pfa.axis.core.Picture[] param) {
        validatePictures(param);
        localPicturesTracker = param != null;
        this.localPictures = param;
    }
    
    /** 
     * Auto generated add method for the array for convenience
     * @param param hr.ponge.pfa.axis.core.Picture
     */
    public void addPictures(hr.ponge.pfa.axis.core.Picture param) {
        if ((localPictures) == null) {
            localPictures = new hr.ponge.pfa.axis.core.Picture[]{  };
        } 
        localPicturesTracker = true;
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localPictures);
        list.add(param);
        this.localPictures = ((hr.ponge.pfa.axis.core.Picture[])(list.toArray(new hr.ponge.pfa.axis.core.Picture[list.size()])));
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType) throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && ((namespacePrefix.trim().length()) > 0)) {
                writeAttribute("xsi" ,"http://www.w3.org/2001/XMLSchema-instance" ,"type" ,(namespacePrefix + ":ReadPictureResp") ,xmlWriter);
            } else {
                writeAttribute("xsi" ,"http://www.w3.org/2001/XMLSchema-instance" ,"type" ,"ReadPictureResp" ,xmlWriter);
            }
        } 
        if (localPicturesTracker) {
            if ((localPictures) != null) {
                for (int i = 0 ; i < (localPictures.length) ; i++) {
                    if ((localPictures[i]) != null) {
                        localPictures[i].serialize(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/core/operations" , "pictures") ,xmlWriter);
                    } else {
                    }
                }
            } else {
                throw new org.apache.axis2.databinding.ADBException("pictures cannot be null!!");
            }
        } 
    ...
    private void writeStartElement(java.lang.String prefix, java.lang.String namespace, java.lang.String localPart, javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
        ...
        if (writerPrefix != null) {
            ...
            if ((namespace.length()) == 0) {
                ...
                prefix = hr.ponge.pfa.axis.core.operations.ReadPictureResp.generatePrefix(namespace);
            } 
    ...
    private void writeQName(javax.xml.namespace.QName qname, javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
        ...
        if (namespaceURI != null) {
            ...
            if (prefix == null) {
                prefix = hr.ponge.pfa.axis.core.operations.ReadPictureResp.generatePrefix(namespaceURI);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
        ...
        if (localPicturesTracker) {
            if ((localPictures) != null) {
                for (int i = 0 ; i < (localPictures.length) ; i++) {
                    if ((localPictures[i]) != null) {
                        elementList.add(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/core/operations" , "pictures"));
                        elementList.add(localPictures[i]);
                    } else {
                    }
                }
            } else {
    ...
    public static class Factory {
         ...
         */
        public static hr.ponge.pfa.axis.core.operations.ReadPictureResp parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            hr.ponge.pfa.axis.core.operations.ReadPictureResp object = new hr.ponge.pfa.axis.core.operations.ReadPictureResp();
            int event;
            ...
            try {
                ...
                if ((reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance" ,"type")) != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!("ReadPictureResp".equals(type))) {
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return ((hr.ponge.pfa.axis.core.operations.ReadPictureResp)(hr.ponge.pfa.axis.ExtensionMapper.getTypeObject(nsUri ,type ,reader)));
                        } 
                    } 
                } 
                ...
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
                if ((reader.isStartElement()) && (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/core/operations" , "pictures").equals(reader.getName()))) {
                    list1.add(hr.ponge.pfa.axis.core.Picture.Factory.parse(reader));
                    ...
                    while (!loopDone1) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/core/operations" , "pictures").equals(reader.getName())) {
                                list1.add(hr.ponge.pfa.axis.core.Picture.Factory.parse(reader));
                            } else {
                                loopDone1 = true;
                            }
                    ...
                    object.setPictures(((hr.ponge.pfa.axis.core.Picture[])(org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(hr.ponge.pfa.axis.core.Picture.class ,list1))));
                } else {
                }
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
...
setErrors(er);
    ...
    public void addPictures_(hr.ponge.pfa.service.core.picture.PictureDTO arg) {
        addPictures((hr.ponge.pfa.axis.core.Picture)arg);
    }
    
    public void setPictures_(hr.ponge.pfa.service.core.picture.PictureDTO[] arg) {
        hr.ponge.pfa.axis.core.Picture[] er = new hr.ponge.pfa.axis.core.Picture[arg.length];
 for(int i=0;i<arg.length;i++){ 
     er[i]=(hr.ponge.pfa.axis.core.Picture) arg[i]; 
 }
setPictures(er);
    }
    
    public hr.ponge.pfa.service.core.picture.PictureDTO[] getPictures_() {
        return getPictures();
    }
