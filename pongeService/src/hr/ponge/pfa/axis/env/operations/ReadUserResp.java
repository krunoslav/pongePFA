...
/** 
 *  ReadUserResp bean class
 */
@java.lang.SuppressWarnings(value = {"unchecked" ,"unused"})
public class ReadUserResp implements hr.ponge.pfa.service.env.user.ReadUserRespDTO , org.apache.axis2.databinding.ADBBean {
    /** 
     * field for Users
     * This was an Array!
     */
    protected hr.ponge.pfa.axis.env.User[] localUsers;
     ...
     * @return hr.ponge.pfa.axis.env.User[]
     */
    public hr.ponge.pfa.axis.env.User[] getUsers() {
        return localUsers;
    }
     ...
     */
    protected void validateUsers(hr.ponge.pfa.axis.env.User[] param) {
    }
     ...
     * @param param Users
     */
    public void setUsers(hr.ponge.pfa.axis.env.User[] param) {
        validateUsers(param);
     ...
     * @param param hr.ponge.pfa.axis.env.User
     */
    public void addUsers(hr.ponge.pfa.axis.env.User param) {
        if ((localUsers) == null) {
            localUsers = new hr.ponge.pfa.axis.env.User[]{  };
        } 
        localUsersTracker = true;
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localUsers);
        list.add(param);
        this.localUsers = ((hr.ponge.pfa.axis.env.User[])(list.toArray(new hr.ponge.pfa.axis.env.User[list.size()])));
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType) throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && ((namespacePrefix.trim().length()) > 0)) {
                writeAttribute("xsi" ,"http://www.w3.org/2001/XMLSchema-instance" ,"type" ,(namespacePrefix + ":ReadUserResp") ,xmlWriter);
            } else {
                writeAttribute("xsi" ,"http://www.w3.org/2001/XMLSchema-instance" ,"type" ,"ReadUserResp" ,xmlWriter);
            }
        } 
            ...
            if ((localUsers) != null) {
                for (int i = 0 ; i < (localUsers.length) ; i++) {
                    if ((localUsers[i]) != null) {
                        localUsers[i].serialize(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env/operations" , "users") ,xmlWriter);
                    } else {
                    }
                }
            } else {
    ...
    private void writeStartElement(java.lang.String prefix, java.lang.String namespace, java.lang.String localPart, javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
        ...
        if (writerPrefix != null) {
            ...
            if ((namespace.length()) == 0) {
                ...
                prefix = hr.ponge.pfa.axis.env.operations.ReadUserResp.generatePrefix(namespace);
            } 
    ...
    private void writeQName(javax.xml.namespace.QName qname, javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
        ...
        if (namespaceURI != null) {
            ...
            if (prefix == null) {
                prefix = hr.ponge.pfa.axis.env.operations.ReadUserResp.generatePrefix(namespaceURI);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
        ...
        if (localUsersTracker) {
            if ((localUsers) != null) {
                for (int i = 0 ; i < (localUsers.length) ; i++) {
                    if ((localUsers[i]) != null) {
                        elementList.add(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env/operations" , "users"));
    ...
    public static class Factory {
         ...
         */
        public static hr.ponge.pfa.axis.env.operations.ReadUserResp parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            hr.ponge.pfa.axis.env.operations.ReadUserResp object = new hr.ponge.pfa.axis.env.operations.ReadUserResp();
            int event;
            ...
            try {
                ...
                if ((reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance" ,"type")) != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!("ReadUserResp".equals(type))) {
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return ((hr.ponge.pfa.axis.env.operations.ReadUserResp)(hr.ponge.pfa.axis.ExtensionMapper.getTypeObject(nsUri ,type ,reader)));
                        } 
                    } 
                } 
                ...
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
                if ((reader.isStartElement()) && (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env/operations" , "users").equals(reader.getName()))) {
                    list1.add(hr.ponge.pfa.axis.env.User.Factory.parse(reader));
                    ...
                    while (!loopDone1) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env/operations" , "users").equals(reader.getName())) {
                                list1.add(hr.ponge.pfa.axis.env.User.Factory.parse(reader));
                            } else {
                                loopDone1 = true;
                            }
                    ...
                    object.setUsers(((hr.ponge.pfa.axis.env.User[])(org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(hr.ponge.pfa.axis.env.User.class ,list1))));
                } else {
                }
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
