...
/** 
 *  ReadUserReq bean class
 */
@java.lang.SuppressWarnings(value = {"unchecked" ,"unused"})
public class ReadUserReq implements hr.ponge.pfa.service.env.user.ReadUserReqDTO , org.apache.axis2.databinding.ADBBean {
    /** 
     * field for Id
     */
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType) throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && ((namespacePrefix.trim().length()) > 0)) {
                writeAttribute("xsi" ,"http://www.w3.org/2001/XMLSchema-instance" ,"type" ,(namespacePrefix + ":ReadUserReq") ,xmlWriter);
            } else {
                writeAttribute("xsi" ,"http://www.w3.org/2001/XMLSchema-instance" ,"type" ,"ReadUserReq" ,xmlWriter);
            }
        } 
        if (localIdTracker) {
            namespace = "http://ponge.hr/pfa/axis/env/operations";
        ...
        if (localLimitsTracker) {
            ...
            localLimits.serialize(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env/operations" , "limits") ,xmlWriter);
        } 
        xmlWriter.writeEndElement();
    }
    ...
    private void writeStartElement(java.lang.String prefix, java.lang.String namespace, java.lang.String localPart, javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
        ...
        if (writerPrefix != null) {
            ...
            if ((namespace.length()) == 0) {
                ...
                prefix = hr.ponge.pfa.axis.env.operations.ReadUserReq.generatePrefix(namespace);
            } 
    ...
    private void writeQName(javax.xml.namespace.QName qname, javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
        ...
        if (namespaceURI != null) {
            ...
            if (prefix == null) {
                prefix = hr.ponge.pfa.axis.env.operations.ReadUserReq.generatePrefix(namespaceURI);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
        ...
        if (localIdTracker) {
            elementList.add(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env/operations" , "id"));
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localId));
        } 
        if (localUsernameTracker) {
            elementList.add(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env/operations" , "username"));
            if ((localUsername) != null) {
        ...
        if (localNameTracker) {
            elementList.add(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env/operations" , "name"));
            if ((localName) != null) {
        ...
        if (localSurnameTracker) {
            elementList.add(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env/operations" , "surname"));
            if ((localSurname) != null) {
        ...
        if (localAddressTracker) {
            elementList.add(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env/operations" , "address"));
            if ((localAddress) != null) {
        ...
        if (localTenantIdTracker) {
            elementList.add(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env/operations" , "tenantId"));
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localTenantId));
        } 
        if (localLimitsTracker) {
            elementList.add(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env/operations" , "limits"));
            if ((localLimits) == null) {
                throw new org.apache.axis2.databinding.ADBException("limits cannot be null!!");
            } 
    ...
    public static class Factory {
         ...
         */
        public static hr.ponge.pfa.axis.env.operations.ReadUserReq parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            hr.ponge.pfa.axis.env.operations.ReadUserReq object = new hr.ponge.pfa.axis.env.operations.ReadUserReq();
            int event;
            ...
            try {
                ...
                if ((reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance" ,"type")) != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!("ReadUserReq".equals(type))) {
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return ((hr.ponge.pfa.axis.env.operations.ReadUserReq)(hr.ponge.pfa.axis.ExtensionMapper.getTypeObject(nsUri ,type ,reader)));
                        } 
                    } 
                } 
                ...
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
                if ((reader.isStartElement()) && (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env/operations" , "id").equals(reader.getName()))) {
                ...
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
                if ((reader.isStartElement()) && (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env/operations" , "username").equals(reader.getName()))) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance" ,"nil");
                    if (("true".equals(nillableValue)) || ("1".equals(nillableValue))) {
                ...
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
                if ((reader.isStartElement()) && (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env/operations" , "name").equals(reader.getName()))) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance" ,"nil");
                    if (("true".equals(nillableValue)) || ("1".equals(nillableValue))) {
                ...
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
                if ((reader.isStartElement()) && (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env/operations" , "surname").equals(reader.getName()))) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance" ,"nil");
                    if (("true".equals(nillableValue)) || ("1".equals(nillableValue))) {
                        throw new org.apache.axis2.databinding.ADBException(("The element: " + ("surname" + "  cannot be null")));
                    } 
                    java.lang.String content = reader.getElementText();
                    object.setSurname(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
                    reader.next();
                } else {
                }
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
                if ((reader.isStartElement()) && (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env/operations" , "address").equals(reader.getName()))) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance" ,"nil");
                    if (("true".equals(nillableValue)) || ("1".equals(nillableValue))) {
                ...
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
                if ((reader.isStartElement()) && (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env/operations" , "tenantId").equals(reader.getName()))) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance" ,"nil");
                    if (("true".equals(nillableValue)) || ("1".equals(nillableValue))) {
                ...
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
                if ((reader.isStartElement()) && (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env/operations" , "limits").equals(reader.getName()))) {
