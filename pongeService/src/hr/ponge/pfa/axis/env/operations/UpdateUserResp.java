...
/** 
 *  UpdateUserResp bean class
 */
@java.lang.SuppressWarnings(value = {"unchecked" ,"unused"})
public class UpdateUserResp implements hr.ponge.pfa.service.env.user.UpdateUserRespDTO , org.apache.axis2.databinding.ADBBean {
    /** 
     * field for User
     */
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType) throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && ((namespacePrefix.trim().length()) > 0)) {
                writeAttribute("xsi" ,"http://www.w3.org/2001/XMLSchema-instance" ,"type" ,(namespacePrefix + ":UpdateUserResp") ,xmlWriter);
            } else {
                writeAttribute("xsi" ,"http://www.w3.org/2001/XMLSchema-instance" ,"type" ,"UpdateUserResp" ,xmlWriter);
            }
        } 
        if (localUserTracker) {
            if ((localUser) == null) {
    ...
    public static class Factory {
         ...
         */
        public static hr.ponge.pfa.axis.env.operations.UpdateUserResp parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            hr.ponge.pfa.axis.env.operations.UpdateUserResp object = new hr.ponge.pfa.axis.env.operations.UpdateUserResp();
            int event;
                ...
                if ((reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance" ,"type")) != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!("UpdateUserResp".equals(type))) {
                            ...
                            return ((hr.ponge.pfa.axis.env.operations.UpdateUserResp)(hr.ponge.pfa.axis.ExtensionMapper.getTypeObject(nsUri ,type ,reader)));
                        } 
                    } 
                } 
