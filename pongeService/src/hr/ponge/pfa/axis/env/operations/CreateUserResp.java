...
/** 
 *  CreateUserResp bean class
 */
@java.lang.SuppressWarnings(value = {"unchecked" ,"unused"})
public class CreateUserResp implements hr.ponge.pfa.service.env.user.CreateUserRespDTO , org.apache.axis2.databinding.ADBBean {
    /** 
     * field for User
     */
    protected hr.ponge.pfa.axis.env.User localUser;
     ...
     */
    public hr.ponge.pfa.axis.env.User getUser() {
        return localUser;
    }
     ...
     * @param param User
     */
    public void setUser(hr.ponge.pfa.axis.env.User param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType) throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && ((namespacePrefix.trim().length()) > 0)) {
                writeAttribute("xsi" ,"http://www.w3.org/2001/XMLSchema-instance" ,"type" ,(namespacePrefix + ":CreateUserResp") ,xmlWriter);
            } else {
                writeAttribute("xsi" ,"http://www.w3.org/2001/XMLSchema-instance" ,"type" ,"CreateUserResp" ,xmlWriter);
            }
        } 
        if (localUserTracker) {
            if ((localUser) == null) {
            ...
            localUser.serialize(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env/operations" , "user") ,xmlWriter);
        } 
    ...
    private void writeStartElement(java.lang.String prefix, java.lang.String namespace, java.lang.String localPart, javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
        ...
        if (writerPrefix != null) {
            ...
            if ((namespace.length()) == 0) {
                ...
                prefix = hr.ponge.pfa.axis.env.operations.CreateUserResp.generatePrefix(namespace);
            } 
    ...
    private void writeQName(javax.xml.namespace.QName qname, javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
        ...
        if (namespaceURI != null) {
            ...
            if (prefix == null) {
                prefix = hr.ponge.pfa.axis.env.operations.CreateUserResp.generatePrefix(namespaceURI);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
        ...
        if (localUserTracker) {
            elementList.add(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env/operations" , "user"));
            if ((localUser) == null) {
                throw new org.apache.axis2.databinding.ADBException("user cannot be null!!");
            } 
    ...
    public static class Factory {
         ...
         */
        public static hr.ponge.pfa.axis.env.operations.CreateUserResp parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            hr.ponge.pfa.axis.env.operations.CreateUserResp object = new hr.ponge.pfa.axis.env.operations.CreateUserResp();
            int event;
            ...
            try {
                ...
                if ((reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance" ,"type")) != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!("CreateUserResp".equals(type))) {
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return ((hr.ponge.pfa.axis.env.operations.CreateUserResp)(hr.ponge.pfa.axis.ExtensionMapper.getTypeObject(nsUri ,type ,reader)));
                        } 
                    } 
                } 
                ...
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
                if ((reader.isStartElement()) && (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env/operations" , "user").equals(reader.getName()))) {
