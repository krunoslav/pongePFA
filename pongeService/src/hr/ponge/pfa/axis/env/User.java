...
public class User implements hr.ponge.pfa.service.env.user.UserDTO , org.apache.axis2.databinding.ADBBean {
    /** 
     * field for Id
     */
    ...
    public void setLastAccessTime(java.util.Calendar param) {
        localLastAccessTimeTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType) throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException {
        ...
        if (localLastAccessTimeTracker) {
            ...
            if ((localLastAccessTime) == null) {
                throw new org.apache.axis2.databinding.ADBException("lastAccessTime cannot be null!!");
            } else {
    ...
    private void writeStartElement(java.lang.String prefix, java.lang.String namespace, java.lang.String localPart, javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
        ...
        if (writerPrefix != null) {
            ...
            if ((namespace.length()) == 0) {
                ...
                prefix = hr.ponge.pfa.axis.env.User.generatePrefix(namespace);
            } 
    ...
    private void writeQName(javax.xml.namespace.QName qname, javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
        ...
        if (namespaceURI != null) {
            ...
            if (prefix == null) {
                prefix = hr.ponge.pfa.axis.env.User.generatePrefix(namespaceURI);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
        ...
        if (localSurnameTracker) {
            elementList.add(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env" , "surname"));
            if ((localSurname) != null) {
        ...
        if (localUsernameTracker) {
            elementList.add(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env" , "username"));
            if ((localUsername) != null) {
        ...
        if (localDateOfBirthTracker) {
            elementList.add(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env" , "dateOfBirth"));
            if ((localDateOfBirth) != null) {
        ...
        if (localLastAccessTimeTracker) {
            elementList.add(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env" , "lastAccessTime"));
            if ((localLastAccessTime) != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localLastAccessTime));
            } else {
                throw new org.apache.axis2.databinding.ADBException("lastAccessTime cannot be null!!");
            }
        } 
        if (localTenantIdTracker) {
            elementList.add(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env" , "tenantId"));
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localTenantId));
        } 
        if (localTenantNameTracker) {
            elementList.add(new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env" , "tenantName"));
            if ((localTenantName) != null) {
    ...
    public static class Factory {
         ...
         */
        public static hr.ponge.pfa.axis.env.User parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            hr.ponge.pfa.axis.env.User object = new hr.ponge.pfa.axis.env.User();
            int event;
            ...
            try {
                ...
                if ((reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance" ,"type")) != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!("User".equals(type))) {
                            ...
                            return ((hr.ponge.pfa.axis.env.User)(hr.ponge.pfa.axis.ExtensionMapper.getTypeObject(nsUri ,type ,reader)));
                        } 
                    } 
                } 
                ...
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
                if ((reader.isStartElement()) && (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env" , "surname").equals(reader.getName()))) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance" ,"nil");
                    if (("true".equals(nillableValue)) || ("1".equals(nillableValue))) {
                ...
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
                if ((reader.isStartElement()) && (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env" , "username").equals(reader.getName()))) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance" ,"nil");
                    if (("true".equals(nillableValue)) || ("1".equals(nillableValue))) {
                ...
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
                if ((reader.isStartElement()) && (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env" , "address").equals(reader.getName()))) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance" ,"nil");
                    if (("true".equals(nillableValue)) || ("1".equals(nillableValue))) {
                ...
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
                if ((reader.isStartElement()) && (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env" , "dateOfBirth").equals(reader.getName()))) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance" ,"nil");
                    if (("true".equals(nillableValue)) || ("1".equals(nillableValue))) {
                ...
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
                if ((reader.isStartElement()) && (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env" , "lastAccessTime").equals(reader.getName()))) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance" ,"nil");
                    if (("true".equals(nillableValue)) || ("1".equals(nillableValue))) {
                        throw new org.apache.axis2.databinding.ADBException(("The element: " + ("lastAccessTime" + "  cannot be null")));
                    } 
                    java.lang.String content = reader.getElementText();
                    object.setLastAccessTime(org.apache.axis2.databinding.utils.ConverterUtil.convertToDateTime(content));
                    reader.next();
                } else {
                }
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
                if ((reader.isStartElement()) && (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env" , "tenantId").equals(reader.getName()))) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance" ,"nil");
                    if (("true".equals(nillableValue)) || ("1".equals(nillableValue))) {
                ...
                while ((!(reader.isStartElement())) && (!(reader.isEndElement())))
                    reader.next();
                if ((reader.isStartElement()) && (new javax.xml.namespace.QName("http://ponge.hr/pfa/axis/env" , "tenantName").equals(reader.getName()))) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance" ,"nil");
                    if (("true".equals(nillableValue)) || ("1".equals(nillableValue))) {
